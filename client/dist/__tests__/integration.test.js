...
describe('EfSec Integration Tests', () => {
    describe('Client Initialization', () => {
        ...
        test('should attempt initialization with valid parameters', async () => {
            ...
            await expect(client.init('valid_token', 'valid_user')).rejects.not.toThrow(/Authentication required/);
        });
    });
    ...
    describe('Method Availability', () => {
        test('should expose expected public methods', () => {
            ...
            const methods = Object.getOwnPropertyNames(proto).filter(name => typeof proto[name] === 'function' && name !== 'constructor');
