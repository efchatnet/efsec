export interface E2EIntegrationConfig {
    ...
    onE2EStatusChange?: (enabled: boolean) => void;
    debug?: boolean;
}
...
export declare class E2EWebSocketInterceptor {
     ...
     */
    processOutgoing(message: any, recipientId?: string): Promise<any>;
    /**
     * Process incoming message
     */
    processIncoming(message: any, senderId?: string): Promise<any>;
}
/**
